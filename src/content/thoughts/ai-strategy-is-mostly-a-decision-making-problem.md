...
description: "Most companies don’t fail at AI because the models are not capable yet. They fail because they can’t distinguish reversible decisions from irreversible ones and apply the right execution framework to them."
date: 2026-03-18
...
Most, if not all, companies today are discussing their AI strategy or need for one, yet are thinking about it entirely wrong. They start by asking what harness or model provider they should use. Yet they should first be working on their decision framework for where and how to apply AI to those tasks.
...
- Decisions around what models to use, what prompts, what harnesses, what routing heuristics, retrieval tuning, internal collaboration patterns, and even what vendors to use—where the consequences fall under non-critical thresholds—are mostly two-way doors, Type 2 decisions. If you’re not iterating and running those quickly with instrumentation and metrics within evaluation frameworks, then you are falling behind and conceding a compounding advantage to faster competitors and startups.

You can absolutely fail on both sides. Over-govern the reversible decisions and you become slow, risk-averse, and performative. Under-govern the irreversible decisions and you end up explaining preventable incidents to your board, your customers, and maybe regulators. Neither outcome is strategic and the operating fix is boring on purpose.
...
This sounds simple because it is. Most companies just stop doing it as they scale and devolve to risk aversion and watch their innovation rate stagnate, often not knowing why. They try to solve decision confusion with bigger committees, more architecture diagrams, and longer policy docs. They get more decision-makers involved, then stakeholders, then the meetings to plan the meetings start. And it feels like progress because it creates activity and motion, yet don't be fooled: this is not progress.

If you want a practical 30-day reset, start by mapping the last five decisions your company made around AI (or are actively avoiding). You’ll probably find the same pattern I have seen even in my own startup: a handful of high-consequence decisions were under-specified, while a pile of low-consequence decisions were over-processed, met about, discussed about, and thought about ad nauseam.

If you can fix that split, then you, your team, and your organization can change quickly. Individuals stop waiting for permission they don't need. Teams stop fighting over who won the last few decisions and begin to focus on impact rather than politics. Security, governance, and operations teams start focusing where they actually add risk-adjusted value. Leadership gets more time back and cleaner visibility into where speed is safe and where caution is mandatory.
